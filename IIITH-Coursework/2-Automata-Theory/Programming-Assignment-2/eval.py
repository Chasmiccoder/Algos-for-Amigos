'''
# Eval Script for automata assignment (given by TAs)
...
for directory_stud in sorted_alphanumeric(os.listdir(directory_programs)):
    ...
    for filename_stud in sorted_alphanumeric(os.listdir(directory_programs + '/' + directory_stud)):
        ...
        if filename_stud.endswith('.cpp'):
            subprocess.call(['g++', directory_programs + '/' + directory_stud + '/' + filename_stud, '-o', directory_programs + '/' + directory_stud + '/' + filename_stud[:-4] + '.out'])
            ...
            with open('results.csv', 'a') as csvfile:
                ...
                for filename in sorted_alphanumeric(os.listdir(directory)):
                    ...
                    if os.path.isfile(f):
                        ...
                        output = subprocess.check_output(["./timeout", "-m", "100000", "-t", "1", full_filename], stdin=open(f, "r"), stderr=open(os.devnull, "w"))
